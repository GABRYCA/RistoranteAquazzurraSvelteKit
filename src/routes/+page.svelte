...
<svelte:head>
    <title>Home - Ristorante Aquazzurra</title>
</svelte:head>
...
<div class="row mx-1 mx-lg-4">
    <div class="col">
        ...
        <div class="row mt-4 align-items-center">
            <div class="col">
                <div id="hero-carousel" class="carousel slide shadow" data-bs-ride="carousel" data-aos="fade-up">
                    <div class="carousel-inner rounded" style="max-height: 89vh">
                        <div class="carousel-item active">
                            <div class="d-flex align-items-center justify-content-center">
                                <img src="/media/photos/webp/0008-optimized.webp" alt="Carousel 1" loading="lazy"
                                     class="d-block rounded w-100"/>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="d-flex align-items-center justify-content-center">
                                <img src="/media/photos/webp/0010-optimized.webp" alt="Carousel 2"
                                     class="d-block rounded w-100"/>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="d-flex align-items-center justify-content-center">
                                <img src="/media/photos/webp/0022-optimized.webp" alt="Carousel 3"
                                     class="d-block rounded w-100"/>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="d-flex align-items-center justify-content-center">
                                <img src="/media/photos/webp/0007-optimized.webp" alt="Carousel 4"
                                     class="d-block rounded w-100"/>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="d-flex align-items-center justify-content-center">
                                <img src="/media/photos/webp/0005-optimized.webp" alt="Carousel 5" loading="lazy"
                                     class="d-block rounded w-100"/>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mt-4">
            <div class="col">
                <div class="row p-4 m-0 rounded shadow" style="background-color: #F2F2F2;" data-aos="fade-up"
                    ...
                    <div class="col-12 col-lg-7">
                        <div class="row h-100 rounded shadow">
                            <img class="img-fluid h-auto p-0 rounded" src="/media/photos/webp/0010-optimized.webp"
                                 alt="inside restaurant"
                                 style="max-height: 50vh; object-fit: cover; object-position: bottom;">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-4">
            <div class="col" data-aos="fade-up" data-aos-duration="700">
                <div class="row justify-content-around p-4 m-0 rounded shadow" data-aos="fade-in"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body bg-gradient-light">
                        ...
                        <ul class="nav nav-pills mb-4 justify-content-center" id="categoryTab" role="tablist">
                            {#each categories as category, index}
                                <li class="nav-item" role="presentation">
                                    <button class={`nav-link ${index === 0 ? 'active' : ''}`} id="{category.name}-tab"
                                            data-bs-toggle="tab" data-bs-target="#{category.name}" type="button"
                        ...
                        <div class="tab-content" id="categoryTabContent">
                            {#each categories as category, index}
                                <div class={`tab-pane fade ${index === 0 ? 'show active' : ''}`} id="{category.name}"
        ...
        <div class="modal fade" id="appetizerModal" tabindex="-1" aria-labelledby="appetizerModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-primary text-white">
        ...
        <div class="modal fade" id="firstCourseModal" tabindex="-1" aria-labelledby="firstCourseModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-primary text-white">
        ...
        <div class="modal fade" id="hamburgerModal" tabindex="-1" aria-labelledby="hamburgerModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-primary text-white">
        ...
        <div class="modal fade" id="secondCourseModal" tabindex="-1" aria-labelledby="secondCourseModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-primary text-white">
        ...
        <div class="row m-0 mt-4 text-center">
            <div class="col">
                <div class="row justify-content-center" data-aos="fade-up">
                    <iframe class="col-12 col-lg-4 mb-4 mb-lg-0 p-0 rounded shadow"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1260.0995627918023!2d8.695776109231604!3d46.06681115229856!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4785c56b2ce59811%3A0xfd8f2e372b58c029!2sRistorante%20Aquazzurra!5e0!3m2!1sit!2sit!4v1693565301234!5m2!1sit!2sit"
                            style="min-height: 40vh" allowfullscreen="" loading="lazy"
                            referrerpolicy="no-referrer-when-downgrade" data-bs-toggle="tooltip" data-bs-placement="top"
                            title="Google Maps"></iframe>
                    <div class="col-12 col-lg-8 text-end position-relative pe-0 ps-0 ps-lg-2">
                        <img src="/media/photos/webp/0013-optimized.webp" loading="lazy"
                             class="img-fluid rounded shadow" alt="Location"
                             style="min-height: 40vh; max-height: 80vh;">
                        <div class="bg-light position-absolute top-50 start-50 translate-middle p-3 text-center rounded shadow"
                             data-aos="zoom-in">
                            <h3 class="pt-1">Cannobio, VB</h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Sezione Contatti -->
        <div class="row mx-auto mt-4 p-5 d-flex align-items-center justify-content-center rounded shadow"
             style="background-image: url('/media/photos/webp/0014-optimized.webp'); background-size: cover; background-attachment: fixed; min-height: 40vh;">
            <div class="col">
                <div class="row bg-white w-100 pt-3 pb-4 m-0 rounded" data-aos="zoom-in">
                    <div class="col">
                        <div class="row">
                        ...
                        <div class="row mt-auto mt-lg-1 justify-content-center">
                            <div class="col-md-5 d-flex flex-column align-items-center mt-3 mt-lg-auto text-center">
                                <div class="d-flex flex-row align-items-center">
                                    <i class="fas fa-map-marker-alt fa-2x mb-2" style="color: #7BB5D3;"></i>
                                    <p class="fs-5 mt-2 ms-2">Cannobio, VB</p>
                                </div>
                                <span class="text-center thin-text">Viale Vittorio Veneto 37, 28822</span>
                            </div>
